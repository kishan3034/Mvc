...
namespace Microsoft.AspNetCore.Mvc.Analyzers
{
    public class AvoidHtmlPartialAnalyzerTest
    {
        ...
        private MvcDiagnosticExecutor Executor { get; } = new MvcDiagnosticExecutor(new AvoidHtmlPartialAnalyzer());
        ...
        {
            // Arrange
            var expectedLocation = testSource.DefaultMarkerLocation.Value;
        ...
        {
            return TestSource.Read(nameof(AvoidHtmlPartialAnalyzerTest), testMethod);
        }
    }
}
